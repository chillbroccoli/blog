---
id: 3
title: Some another post
date: 26/06/2022
description: Suspendisse gravida velit quis nisi iaculis, ac cursus odio elementum. Duis eleifend sapien vitae iaculis euismod. Donec iaculis pellentesque turpis, vel egestas nisl iaculis vitae.
---
  ...
  return (
    ...
    >
      ...
      <Listbox.Button className="flex h-6 w-6 items-center justify-center rounded-lg shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-slate-700 dark:ring-inset dark:ring-white/5">
        ...
        <Sun className="hidden h-4 w-4 fill-sky-400 [[data-theme=light]_&]:block" />
        <Moon className="hidden h-4 w-4 fill-sky-400 [[data-theme=dark]_&]:block" />
